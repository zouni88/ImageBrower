...
import top.smallc.picturebrower.view.DetailOnlineActivity;
...
public class TitleGridOnlineAdapter extends RecyclerView.Adapter<TitleGridOnlineAdapter.RecyclerHolder> {
    private Context mContext;
    private ArrayList<Parent> dataList = new ArrayList<>();

    private AutoHeightTools autoHeightTools;
    public TitleGridOnlineAdapter(RecyclerView recyclerView) {
    ...
    public void setData(boolean isRefresh,List<Parent> list) {
        if(isRefresh){
            dataList.clear();
        }
        if (null != dataList) {
    ...
    class RecyclerHolder extends RecyclerView.ViewHolder {
        ...
        private RecyclerHolder(View itemView) {
            ...
            frameLayout.setOnClickListener(v -> {
                ...
                DetailOnlineActivity.start(v.getContext(),parent);
            });
